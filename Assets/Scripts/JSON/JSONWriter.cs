...
namespace TinyJson
{
    ...
    public static class JSONWriter
    {
        ...
        static void AppendValue(StringBuilder stringBuilder, object item)
        {
            ...
            {
                float f = (float)Math.Round((float)item, 4);
                stringBuilder.Append(f.ToString("R", System.Globalization.CultureInfo.InvariantCulture));

                //stringBuilder.Append(((float)item).ToString("G4", System.Globalization.CultureInfo.InvariantCulture));
            }
